...
class AddTaskAction extends Action
{
    ...
    protected array $data = [
        'configPreset' => 'default', // config Preset (threads) https://en.a-parser.com/docs/assets/images/tour_ru_2_task_editor_easy-en-9808b6f4044c8ea214edbdc94b526515.png
        'preset'       => 'default', // task preset https://en.a-parser.com/docs/assets/images/tour_ru_2_task_editor_easy-en-9808b6f4044c8ea214edbdc94b526515.png
        'parsers'      => [],
        'queriesFrom'  => 'text'
    ];
    ...
    //Method 2 - Provide a taskPreset with saved configuration. If any parsers passed to task they will overwrite existing config, so calling this method will raise an exception
